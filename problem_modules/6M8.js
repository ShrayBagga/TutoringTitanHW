...
const problemGenerators = [
    ...
    () => { const samp = "50 randomly selected students", pop = "all students at a school"; return { problem: `If a survey uses \\(${samp}\\) to find preferences of \\(${pop}\\), which is the sample and which is the population?`, answer: `Sample: \\(${samp}\\). Population: \\(${pop}\\).`, checkAnswer: `Sample:50,Population:all` }; },
    ...
    () => { const question = "How many hours do 6th graders sleep per night?"; return { problem: `To answer: "${question}", what data would you need to collect?`, answer: `The number of hours of sleep for a sample of 6th graders.`, checkAnswer: `hours of sleep` }; },
    ...
    () => { const setA = "5, 5, 5, 5", setB = "2, 5, 8, 12"; return { problem: `Which data set has more variability: Set A (\\(${setA}\\)) or Set B (\\(${setB}\\))?`, answer: `Set B`, checkAnswer: `Set B` }; },
    ...
    () => { const topic = "the most popular lunch choice in the cafeteria"; return { problem: `To investigate \\(${topic}\\), who should you survey?`, answer: `A random sample of students who eat in the cafeteria.`, checkAnswer: `A random sample of students` }; },
