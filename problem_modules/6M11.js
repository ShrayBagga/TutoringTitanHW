...
const problemGenerators = [
    ...
    () => {
        ...
        return { problem: `For the data \\(${data.join(', ')}\\), what is the peak of the distribution shown on a dot plot?`, answer: `The peak is at 3.`, checkAnswer: "3" };
    },
    ...
    () => {
        const data = "10, 20, 25, 28, 30, 32, 40, 45, 50";
        return { problem: `For the data set \\(${data}\\), what is the median (Q2)?`, answer: `30`, checkAnswer: "30" };
    },
    () => {
        const data = "10, 20, 25, 28, 30, 32, 40, 45, 50";
        return { problem: `For the data set \\(${data}\\), what is the first quartile (Q1)?`, answer: `22.5`, checkAnswer: "22.5", hint: "The median of the lower half: (20+25)/2" };
    },
    () => {
        const data = "10, 20, 25, 28, 30, 32, 40, 45, 50";
        return { problem: `For the data set \\(${data}\\), what is the third quartile (Q3)?`, answer: `42.5`, checkAnswer: "42.5", hint: "The median of the upper half: (40+45)/2" };
    },
...
function generate(settings) {
    ...
    return { ...problemData, hint: problemData.hint || "Different graphs are used to highlight different features of a data set." };
}

export const module = {
    topicId: 'g6_data_displays',
