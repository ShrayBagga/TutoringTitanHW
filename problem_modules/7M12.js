...
const problemGenerators = [
    () => { return { problem: `You want to simulate flipping a fair coin. What tool could you use?`, answer: `A random number generator (1=heads, 2=tails), a 6-sided die (even=heads, odd=tails), or actually flipping a coin.`, checkAnswer: "random number generator" }; },
    () => { return { problem: `How could you use a standard 6-sided die to simulate an event with a 1/3 probability of success?`, answer: `Let rolling a 1 or 2 be a success, and 3, 4, 5, 6 be a failure.`, checkAnswer: "rolling a 1 or 2" }; },
    () => { return { problem: `A basketball player makes 75% of their free throws. How could you simulate one free throw using a random number generator from 1 to 4?`, answer: `Let the numbers 1, 2, and 3 represent a made shot, and 4 represent a missed shot.`, checkAnswer: "1,2,3 is a make" }; },
    ...
    () => { return { problem: `Why are simulations useful in probability?`, answer: `They help estimate probabilities of complex events that are difficult to calculate theoretically.`, checkAnswer: "estimate complex events" }; },
    ...
    () => { const prob = "20%"; return { problem: `An event has a \\(${prob}\\) chance of occurring. How can you simulate this with random digits from 0-9?`, answer: `Let two digits (e.g., 0 and 1) represent the event occurring, and the other eight digits represent it not occurring.`, checkAnswer: "two digits" }; },
    ...
    () => { return { problem: `To simulate the probability of having a boy or a girl, what is the most common and simple tool to use?`, answer: `A fair coin.`, checkAnswer: "A coin" }; },
    ...
    () => { const items=["a coin", "a die", "a spinner"]; const i=getRandomInt(0,2); return { problem: `Name a device that can be used to generate random outcomes for a simulation.`, answer: `Examples: ${items[i]}`, checkAnswer: items[i] }; },
    () => { return { problem: `What is the first step in designing a probability simulation?`, answer: `Identify the simple event and its theoretical probability.`, checkAnswer: "Identify the event" }; },
    ...
    () => { const prob = "1/6"; return { problem: `You want to simulate an event with a \\(${prob}\\) probability. What is a simple and appropriate tool?`, answer: `A standard 6-sided die.`, checkAnswer: "A die" }; },
    ...
    () => { return { problem: `What is the purpose of conducting a large number of trials in a simulation?`, answer: `To improve the accuracy of the experimental probability and make it a better estimate of the theoretical probability.`, checkAnswer: "improve accuracy" }; },
];
